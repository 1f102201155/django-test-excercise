...
class TaskModelTestCase(TestCase):
    ...
    def test_is_overdue_furture(self):
        due = timezone.make_aware(datetime(2023, 6, 30, 23, 59, 59))
...
class TodoViewTestCase(TestCase):
    ...
    def test_index_get_order_post(self):
        task1 = Task(title='task1', due_at=timezone.make_ware(datetime(2023, 7, 1)))
        task1.save()
        task2 = Task(title='task2', due_at=timezone.make_ware(datetime(2023, 8, 1)))
        task2.save()
        client=Client.get('/?order=post')
